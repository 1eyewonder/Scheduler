...
namespace SchedulerAPI.Migrations
{
    ...
    [Migration("20200722060413_AddedProjectAndCustomerTables")]
    partial class AddedProjectAndCustomerTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchedulerAPI.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchedulerAPI.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchedulerAPI.Models.Job", b =>
                {
                    b.HasOne("SchedulerAPI.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("SchedulerAPI.Models.Project", b =>
                {
                    b.HasOne("SchedulerAPI.Models.Customer", "Customer")
                        .WithMany()
